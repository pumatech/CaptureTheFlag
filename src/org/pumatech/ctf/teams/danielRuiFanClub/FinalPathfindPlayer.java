...
//	testLoc.setRow(24);
	...
	public Location pathfind(Location targetLocation) {
		...
		if(this.getGrid().isValid(infront(targetDirection)) && !(this.getGrid().get(infront(targetDirection)) instanceof Rock) && clearThreeInfront(infront(targetDirection), targetDirection) && !isFlagZone(infront(targetDirection)) && !friendlyPlayer(infront(targetDirection)) && (!enemyNear(infront(targetDirection)) || isEnemyFlagZone(infront(targetDirection))) && !(pastLocCounter > 3 && infront(targetDirection).equals(pastLoc))) {
//			System.out.println("front");
		...
		else if(this.getGrid().isValid(frontLeft(targetDirection)) && !(this.getGrid().get(frontLeft(targetDirection)) instanceof Rock) && clearThreeInfront(frontLeft(targetDirection), targetDirection) && !isFlagZone(frontLeft(targetDirection)) && !friendlyPlayer(frontLeft(targetDirection)) && (!enemyNear(frontLeft(targetDirection)) || isEnemyFlagZone(frontLeft(targetDirection))) && !(pastLocCounter > 3 && frontLeft(targetDirection).equals(pastLoc))) {
...
//			System.out.println(this.getGrid().get(frontLeft(targetDirection)));
			if(frontLeft(targetDirection).equals(pastLoc)) {
				pastLocCounter++;
			}
			else {
				pastLocCounter = 0;
		...
		else if(this.getGrid().isValid(frontRight(targetDirection)) && !(this.getGrid().get(frontRight(targetDirection)) instanceof Rock) && clearThreeInfront(frontRight(targetDirection), targetDirection) && !isFlagZone(frontRight(targetDirection)) && !friendlyPlayer(frontRight(targetDirection)) && (!enemyNear(frontRight(targetDirection)) || isEnemyFlagZone(frontRight(targetDirection))) && !(pastLocCounter > 3 && frontRight(targetDirection).equals(pastLoc))) {
...
//			System.out.println(this.getGrid().get(frontRight(targetDirection)));
			if(frontRight(targetDirection).equals(pastLoc)) {
				pastLocCounter++;
			}
			else {
				pastLocCounter = 0;
		...
		else if(this.getGrid().isValid(left(targetDirection)) && !(this.getGrid().get(left(targetDirection)) instanceof Rock) && !isFlagZone(left(targetDirection)) && !friendlyPlayer(left(targetDirection)) && (!enemyNear(left(targetDirection)) || isEnemyFlagZone(left(targetDirection))) && !(pastLocCounter > 3 && left(targetDirection).equals(pastLoc))) {
//			System.out.println("left");
			if(left(targetDirection).equals(pastLoc)) {
				pastLocCounter++;
			}
			else {
				pastLocCounter = 0;
		...
		else if(this.getGrid().isValid(right(targetDirection)) && !(this.getGrid().get(right(targetDirection)) instanceof Rock) && !isFlagZone(right(targetDirection)) && !friendlyPlayer(right(targetDirection)) && (!enemyNear(right(targetDirection)) || isEnemyFlagZone(right(targetDirection))) && !(pastLocCounter > 3 && right(targetDirection).equals(pastLoc))) {
//			System.out.println("right");
			if(right(targetDirection).equals(pastLoc)) {
				pastLocCounter++;
			}
			else {
				pastLocCounter = 0;
		...
		else if(this.getGrid().isValid(backLeft(targetDirection)) && !(this.getGrid().get(backLeft(targetDirection)) instanceof Rock) && !isFlagZone(backLeft(targetDirection)) && !friendlyPlayer(backLeft(targetDirection)) && (!enemyNear(backLeft(targetDirection)) || isEnemyFlagZone(backLeft(targetDirection))) && !(pastLocCounter > 3 && backLeft(targetDirection).equals(pastLoc))) {
//			System.out.println("backleft");
			if(backLeft(targetDirection).equals(pastLoc)) {
				pastLocCounter++;
			}
			else {
				pastLocCounter = 0;
		...
		else if(this.getGrid().isValid(backRight(targetDirection)) && !(this.getGrid().get(backRight(targetDirection)) instanceof Rock) && !isFlagZone(backRight(targetDirection)) && !friendlyPlayer(backRight(targetDirection)) && (!enemyNear(backRight(targetDirection)) || isEnemyFlagZone(backRight(targetDirection))) && !(pastLocCounter > 3 && backRight(targetDirection).equals(pastLoc))) {
//			System.out.println("backright");
			if(backRight(targetDirection).equals(pastLoc)) {
				pastLocCounter++;
			}
			else {
				pastLocCounter = 0;
		...
		else if (this.getGrid().isValid(infront(targetDirection+180)) && !(this.getGrid().get(infront(targetDirection+180)) instanceof Rock) && !isFlagZone(infront(targetDirection+180)) && !friendlyPlayer(infront(targetDirection+180)) && (!enemyNear(infront(targetDirection+180)) || isEnemyFlagZone(infront(targetDirection+180))) && !(pastLocCounter > 3 && infront(targetDirection+180).equals(pastLoc))) {
...
//	check out my +90 for only right and - 90 for left
	...
	public boolean isEnemyFlagZone(Location loc) {
		if(friendlyHasFlag()) {
			return false;
		}
		if(loc.getRow() > this.getTeam().getOpposingTeam().getFlag().getLocation().getRow()-5 && loc.getRow() < this.getTeam().getOpposingTeam().getFlag().getLocation().getRow()+5 && loc.getCol() > this.getTeam().getOpposingTeam().getFlag().getLocation().getCol()-5 && loc.getCol() < this.getTeam().getOpposingTeam().getFlag().getLocation().getCol()+5) {
			return true;
		}
		return false;
	}
	...
	public boolean friendlyHasFlag() {
		ArrayList<AbstractPlayer> players = new ArrayList<AbstractPlayer>();
		players.addAll(this.getTeam().getPlayers());
		for(AbstractPlayer player: players) {
			if(player.hasFlag()) {
				return true;
			}
