...
public class GridPanel extends JPanel implements Scrollable, PseudoInfiniteViewport.Pannable {
	...
	public GridPanel(DisplayMap map, ResourceBundle res, BufferedImage backgroundImage) {
		this(map, res);
	...
	public void paintComponent(Graphics g) {
		...
		if (backgroundImage != null) {
	        g2.drawImage(backgroundImage, insets.left, insets.top, numCols * (cellSize + 1) + 1, numRows
	                * (cellSize + 1) + 1, 0, 0, backgroundImage.getWidth(), backgroundImage.getHeight(), null); 
		} else {
